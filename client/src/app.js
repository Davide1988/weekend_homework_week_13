const InstrumentFamilies = require('./models/instrument_families.js').default;
const SelectView = require('./views/select_view.js').default;
const InstrumentFamilyView = require('./views/instrument_family_view.js').default;
